  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-lg-12 d-flex justify-content-center">
        <ul id="menu-flters">
          <li data-filter=".filter-banks" class="bancos">Bancos</li>
    ...
    <div class="row menu-container">
      ...
      <div class="col-lg-6 menu-item filter-banks">
        <div class="menu-content">
          <a class="titulo" href="#">Bancos Afiliados:</a>
        </div>
        <div class="menu-details mt-2">
          <ul class="lista">
            <li><i class="bi bi-check-circle"></i> Acércate a ventanilla e indica que deseas realizar el pago de tu servicio de Internet Nexsatel.</li>
            <li><i class="bi bi-check-circle"></i> Brinda tu código de abonado, ubicado en la parte superior derecha de tu recibo (no consideres 
              los 00 de la izquierda). De ser necesario agregar un código previo al de abonado te lo indicamos líneas abajo.</li>
          </ul>
        </div>
      </div>
      ...
      <!-- ======= Menu bancos ======= -->
      <div class="row" id="banks" style="display:block">
  ...
  $(document).ready(function(){
    $('.bancos').click(function(){
      ...
      $('.lista').html('<li><i class="bi bi-check-circle"></i> Acércate a ventanilla e indica que deseas realizar el pago de tu servicio de Internet.</li>'+
                        '<li><i class="bi bi-check-circle"></i> Brinda tu código de abonado, ubicado en la parte superior derecha de tu recibo (no consideres'+ 
                          'los 00 de la izquierda). De ser necesario agregar un código previo al de abonado te lo indicamos líneas abajo.</li>');
      $('.imagen').html('<img src="assets/img/bank.jpg" class="img-fluid" alt="">');
